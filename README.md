...
```yaml
- uses: jessehouwing/azdo-marketplace@v6.2.3
  id: publish
  with:
    operation: publish
    auth-type: pat
...
```yaml
- uses: jessehouwing/azdo-marketplace/package@v6.2.3
  id: package
  with:
    publisher-id: my-publisher
    extension-id: my-extension
...
```yaml
- uses: jessehouwing/azdo-marketplace/publish@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    publisher-id: my-publisher
    extension-id: my-extension
...
```yaml
- uses: jessehouwing/azdo-marketplace/install@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/share@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/unshare@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/unpublish@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/show@v6.2.3
  id: show
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    publisher-id: my-publisher
...
```yaml
- uses: jessehouwing/azdo-marketplace/query-version@v6.2.3
  id: query
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    publisher-id: my-publisher
...
```yaml
- uses: jessehouwing/azdo-marketplace/wait-for-validation@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/wait-for-installation@v6.2.3
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    publisher-id: my-publisher
    extension-id: my-extension
