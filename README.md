...
```yaml
- uses: jessehouwing/azdo-marketplace@v6.1.2
  id: publish
  with:
    operation: publish
    auth-type: pat
...
```yaml
- uses: jessehouwing/azdo-marketplace/package@v6.1.2
  id: package
  with:
    publisher-id: my-publisher
    extension-id: my-extension
...
```yaml
- uses: jessehouwing/azdo-marketplace/publish@v6.1.2
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    publisher-id: my-publisher
    extension-id: my-extension
...
```yaml
- uses: jessehouwing/azdo-marketplace/install@v6.1.2
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/share@v6.1.2
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/unpublish@v6.1.2
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/wait-for-validation@v6.1.2
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    working-directory: extension
    manifest-file: vss-extension.json
...
```yaml
- uses: jessehouwing/azdo-marketplace/wait-for-installation@v6.1.2
  with:
    token: ${{ secrets.MARKETPLACE_TOKEN }}
    publisher-id: my-publisher
    extension-id: my-extension
